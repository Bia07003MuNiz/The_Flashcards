    ...
    <div class="col-lg-6">
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="{{route('pedidos-periodo')}}">Pedidos/Orçamentos</a>
                <a class="dropdown-item" href="">Solicitações de contato</a>
                <a class="dropdown-item" href="{{route('users.index')}}">Clientes cadastrados</a>
                <a class="dropdown-item" href="{{route('produtos-cadastros')}}">Produtos cadastrados</a>
            </div>
        </div>
    </div>
</div>