...
<div class="modal fade modal__custom" id="modalCookies" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body">
        <div class="estrutura__modal">
          <div class="row row__style">
            <div class="col-lg-7">
              <h1 class="title__modal">Por que utilizamos cookies?</h1>
              <div class="texto__style clearflix">
