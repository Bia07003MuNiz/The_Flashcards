<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <symbol id="teste" viewBox="0 0 512 512">
        <g>
            <g>
                <path
                    d="M454.571,155.299L197.817,1.45c-3.152-1.888-7.074-1.935-10.271-0.125c-3.195,1.81-5.171,5.201-5.171,8.874v87.093
        ...
        <g>
            <g>
                <path
                    d="M272.705,331.947l-3.058-1.832c-4.832-2.896-11.096-1.326-13.991,3.505s-1.326,11.096,3.505,13.991l3.058,1.832
...
<footer class="d-flex flex-wrap justify-content-between align-items-center  text-bg-dark mr-5">
    <div class="container p-3 d-flex flex-wrap justify-content-between align-items-center text-bg-dark mr-5 ">
        <div class="col-md-4 d-flex align-items-center">
            <svg class="bi me-2" width="40" height="32" role="img" aria-label="teste">
                <use xlink:href="#teste" />
            </svg>
            </a>
            <span class="nav-link mb-3 mb-md-0 text-white ">&copy; 2023 Bianca Muniz - THE FLASHCARDS</span>
        </div>
        <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
            <li class="ms-3"><a class=" text-white text-body-secondary" href="#"><svg class="bi"
                        width="24" height="24">
